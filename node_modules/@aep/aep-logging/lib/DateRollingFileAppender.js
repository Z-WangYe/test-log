...
function fileAppender(file, layout, logSize, numBackups, options, timezoneOffset) {
    if (options.folderDate) {
        folderDate = format(options.folderDate, new Date());
        fileObj = path.parse(file);
        file = path.join(fileObj.dir, folderDate, fileObj.base);
    }
    numBackups = numBackups === undefined ? Number.MAX_SAFE_INTEGER : numBackups;
...
//# sourceMappingURL=DateRollingFileAppender.js.map